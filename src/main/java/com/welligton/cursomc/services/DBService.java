...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "welligton lins", "welligtonlinsufac@gmail.com", "02579139206", TipoCliente.PESSOAFISICA);
		...
		Pedido ped1 = new Pedido(null, sdt.parse("30/09/2017 10:32"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdt.parse("10/10/2017 19:35"), cli1, e2);
		
		Pagamento pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1, 6);
		ped1.setPagamento(pagto1);
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdt.parse("20/10/2017 00:00"), null);
